        ...
        <div className="rounded-3xl border border-border bg-card/95 p-7 shadow-2xl backdrop-blur">
          ...
          {step === "details" && (
            ...
            >
              ...
              <button className="w-full rounded-xl bg-orange py-3 text-sm font-bold text-orange-foreground shadow-glow">
                {t("sendOtpBtn")}
              </button>
            </form>
          )}
          ...
          {step === "otp" && (
            ...
            >
              ...
              <input
                ...
                className="w-full rounded-xl border border-border bg-background px-4 py-3 text-center text-lg font-bold tracking-[0.5em] outline-none focus:border-orange"
              />
              {err && <p className="text-xs font-semibold text-red-600">{err}</p>}
